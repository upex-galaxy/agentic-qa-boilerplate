...
export const EXECUTIONS: SimExecution[] = [
  ...
  },
  {
    ...
    breakable: true,
    note: '2ª ejecución de la MISMA ATC (AuthApi.authenticateSuccessfully) reutilizada como precondición: una fila, dos ejecuciones. Dos métodos DISTINTOS con el mismo id serían otra cosa, y `kata:manifest:check` los rechaza.',
  },
  {
    order: 3,
    specId: 'B',
