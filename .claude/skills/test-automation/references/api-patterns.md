...
```
Backend /swagger/v1/swagger.json
        ↓ fetched by `bun run api:sync`
api/openapi.json                     (gitignored)
        ↓ generated by openapi-typescript
api/openapi-types.ts                 (committed, NEVER hand-edit)
        ↓ re-exported
api/schemas/{domain}.types.ts        (hand-written facades)
        ↓ imported
tests/components/api/{Domain}Api.ts  (components)
```
