...
4. After any bump: `bun allure:generate` from existing results (or a sandbox run) and confirm the report renders — landing page must show the Awesome card + both Dashboard cards (`QA Dashboard`, `Smoke — Release Gate`).
