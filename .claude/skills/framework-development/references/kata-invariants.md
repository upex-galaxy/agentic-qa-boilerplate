...
- **Project-wide context**: `.context/business/**`, `.context/master-test-plan.md`, `.context/test-management-system.md`. Owned by `/business-*-map`, `/master-test-plan`, `test-documentation`.
