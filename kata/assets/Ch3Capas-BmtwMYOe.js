import{p as Ae,v as ye,g as s,s as a,c as t,t as P,a as i,e as U,i as O,b as z,d as I,f as c,h as Y,j as T,k as C,w as _e,n as Z,l as Te,m as ee,u as R,A as be,B as Pe,C as ze,o as Ce,q as m,r as ke}from"./index-DNnZUUl0.js";import{T as k,s as se}from"./Term-CyDhQIiO.js";import{C as we}from"./CodePane-zoQo9_1m.js";const N=[{id:"tests",level:"specs",name:"Tests",tenants:"tests/e2e/*.test.ts · tests/integration/*.test.ts",role:"Los specs ORQUESTAN: destructuran el fixture, llaman ATCs y añaden aserciones de flujo. Casi no tienen lógica propia.",rules:["Jerarquía: carpeta = módulo → archivo = feature → describe = ticket → test = escenario.","Las aserciones fijas viven dentro del ATC; el spec solo añade las de flujo."],samples:[{title:"tests/integration/auth/user-session.test.ts",sourcePath:"tests/integration/auth/user-session.test.ts",code:`import { expect, test } from '@TestFixture';
