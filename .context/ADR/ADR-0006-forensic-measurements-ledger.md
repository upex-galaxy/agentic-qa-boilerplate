...
| `orca-orchestration/SKILL.md`, the paragraph on worktree provisioning | Corrected 2026-09-22; the paragraph used to say the opposite. Every other orca measurement lives in `orca-orchestration/references/gotchas.md` by G-id. |
