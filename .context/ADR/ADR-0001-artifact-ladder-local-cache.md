...
The QA planning ladder was ratified on 2026-06-26 and amended on 2026-08-21 (`.agents/skills/agentic-qa-core/references/planning-ladder.md`). It defines four planning altitudes, each with a plan and, above the Master rung, a runner:
...
- `.agents/skills/agentic-qa-core/references/planning-ladder.md` — the ratified ladder and title grammar (§3), the four QA-process Epics (§1), items-over-fields (§4)
